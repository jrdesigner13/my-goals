...
export default function Details() {
  ...
  function fetchDetails() {
    try {
      if (goalId) {
        const goal = useGoal.show(goalId) //mocks.goal
        const transactions = useTransaction.findByGoal(goalId) //mocks.transactions
  ...
  return (
    <View className="flex-1 p-8 pt-12">
      ...
      >
        ...
        <Button title="To Confirm" onPress={handleNewTransaction} />
      </BottomSheet>
    </View>
  )
}
